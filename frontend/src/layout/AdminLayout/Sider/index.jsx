        ...
        >
            <div className={`h-full flex flex-col justify-between overflow-hidden`}>
                ...
                <div className={`h-20 flex items-center transition-all border-b ${collapsed ? 'justify-center px-0' : 'px-6'} ${isDarkMode ? 'border-white/5 bg-[#141416]' : 'border-slate-100 bg-white'}`}>
                    <div className="w-10 h-10 rounded-lg flex items-center justify-center shrink-0 shadow-lg bg-yellow-500 dark:bg-gradient-to-br dark:from-premium-gold dark:to-yellow-600 dark:shadow-premium-gold/20 shadow-yellow-500/20 transition-all duration-300 scale-110">
                        <CarFront className="text-white w-6 h-6 stroke-[2.5]" />
                    </div>
                    {!collapsed && (
