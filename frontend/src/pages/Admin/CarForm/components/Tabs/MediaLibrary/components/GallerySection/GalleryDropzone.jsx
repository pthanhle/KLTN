...
const GalleryDropzone = () => {
    ...
    return (
        <Dragger {...uploadProps} className="mb-8 block border-2 border-dashed border-slate-200 dark:border-white/10 rounded-[24px] hover:border-yellow-500 hover:bg-yellow-500/5 transition-all duration-300 bg-slate-50/50 dark:bg-[#1a1a1c]/50">
