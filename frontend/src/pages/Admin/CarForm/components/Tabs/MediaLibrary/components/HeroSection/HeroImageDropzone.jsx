...
const HeroImageDropzone = () => {
    ...
    return (
        <div className="mt-6">
            <Dragger {...uploadProps} className="block !bg-white/50 dark:!bg-[#141416]/50 border-2 border-dashed border-slate-200 dark:border-white/10 rounded-[32px] hover:border-yellow-500 hover:bg-yellow-500/5 transition-all duration-300">
