...
const ThreeSixtyUploader = ({ 
    ...
    return (
        <section className="flex flex-col gap-8 h-full">
            <div className="bg-white dark:bg-[#141416] p-8 rounded-3xl relative overflow-hidden group shadow-2xl border border-slate-100 dark:border-white/5 h-full flex flex-col">
