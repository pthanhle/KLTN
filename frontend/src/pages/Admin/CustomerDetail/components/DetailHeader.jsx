...
export const DetailHeader = ({
    ...
    const handleLockConfirm = () => {
        modal.confirm({
            title: !isLocked ? t('Xác nhận khóa tài khoản?') : t('Xác nhận mở khóa tài khoản?'),
            content: !isLocked
                ? t('Khách hàng sẽ không thể đăng nhập hoặc đặt dịch vụ sau khi bị khóa.')
                : t('Khách hàng sẽ có thể truy cập lại toàn bộ tính năng của hệ thống.'),
            okText: t('Xác nhận'),
            cancelText: t('Hủy'),
            centered: true,
