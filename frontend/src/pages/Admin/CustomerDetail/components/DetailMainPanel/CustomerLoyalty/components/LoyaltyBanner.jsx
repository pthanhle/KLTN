    ...
    return (
        <div className="bg-gradient-to-br from-yellow-400 to-amber-500 rounded-2xl p-8 flex flex-col xl:flex-row items-center justify-between shadow-2xl shadow-yellow-500/20 relative overflow-hidden">
            ...
            <div className="mb-6 xl:mb-0 relative z-10 w-full xl:w-1/2">
                <h2 className="text-yellow-900/60 text-[10px] font-black uppercase tracking-[0.3em] mb-2">{t('adminCustomers:lblTotalAccumulated', 'Tổng điểm tích lũy thành viên')}</h2>
                <div className="flex items-baseline gap-2">
                    <span className="text-5xl font-black text-slate-900 tracking-tighter">{accumulatedPoints.toLocaleString('vi-VN')}</span>
                ...
                <div className="mt-1 flex items-center gap-2">
                    <span className="text-yellow-900/60 text-[10px] font-bold uppercase tracking-widest">
                        {t('adminCustomers:lblSpendable', 'Điểm khả dụng')}:
                    </span>
