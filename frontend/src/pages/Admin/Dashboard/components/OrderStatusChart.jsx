...
export const OrderStatusChart = ({ data }) => {
    ...
    return (
        <div className="bg-white dark:bg-[#141416] p-6 rounded-3xl border border-slate-200/60 dark:border-white/5 shadow-sm h-full flex flex-col">
            <div className="mb-4">
                <h3 className="text-xl font-bold text-slate-800 dark:text-white">Phân loại đơn hàng</h3>
                <p className="text-sm text-slate-500 dark:text-slate-400">Tổng cộng {total} đơn trong kỳ</p>
            </div>
