...
const InventoryCard = ({ t }) => {
    ...
    return (
        <section className="bg-slate-50 dark:bg-[#23293c] rounded-2xl p-8 shadow-xl shadow-slate-200/20 dark:shadow-none border border-slate-200 dark:border-white/5">
            ...
            <div className="space-y-6">
                <div className="p-6 bg-white dark:bg-[#151b2d] rounded-[1.5rem] border-2 border-transparent transition-all shadow-sm group hover:border-yellow-500/30">
                ...
                <div className="p-6 bg-white dark:bg-[#151b2d] rounded-[1.5rem] border-2 border-transparent transition-all shadow-sm">
                    ...
                    <Controller
                        ...
                        render={({ field, fieldState }) => (
                            <Form.Item validateStatus={fieldState.error ? 'error' : ''} help={fieldState.error?.message} className="mb-0">
                                <div className="flex bg-slate-50 dark:bg-[#111727] p-1.5 rounded-xl shadow-inner">
                                    <button
                                        type="button"
                                    ...
                                    <button
                                        ...
                                        className={`flex-1 py-3.5 px-2 text-[10px] sm:text-xs font-black uppercase tracking-widest rounded-lg transition-all duration-300 ${
                                            field.value !== 'active' 
                                            ? 'bg-slate-200 dark:bg-slate-700 text-slate-800 dark:text-white shadow-md scale-100' 
                                            : 'text-slate-500 hover:text-slate-700 dark:hover:text-white scale-95 hover:scale-100'
                                        }`}
                                    >
