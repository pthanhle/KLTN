        ...
        <section className="bg-white dark:bg-[#191f31] rounded-2xl p-8 shadow-xl shadow-slate-200/20 dark:shadow-none border border-slate-200 dark:border-white/5">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {fields.map((field, index) => (
                    <div key={field.id} className="relative p-6 pt-10 bg-slate-50 dark:bg-[#151b2d] rounded-3xl border-2 border-transparent hover:border-yellow-500/20 transition-all group">
                        <button 
                            type="button"
