export const mockStaffData = [
    ...
    {
        _id: '60d5ecb8b392d700153528b1',
        employeeId: 'INV-113',
        fullName: 'Nguyễn Thị Thuý',
        email: 'thuynt@ttvelocity.com',
        phone: '+84 912345678',
        joinDate: '2022-04-10',
        ...
        performance: {
            kpis: {
                revenue: null, csat: null, efficiency: null, rework: null, inventoryAccuracy: { score: 99.5, target: 99.0 }, avgSla: { time: 1.0, unit: 'h' }
            },
            kanban: {
                todo: [],
                inProgress: [],
                done: [
                    { id: 'IV-211', title: 'Đóng gói đơn hàng lót sàn cao su', priority: 'MEDIUM', billed: 'N/A', customerName: 'Phạm Thị Lan', licensePlate: '51F-123.45', customerPhone: '0901234567', vehicleModel: 'Honda City', appointmentTime: '10:00', description: 'Đã giao cho đơn vị vận chuyển.' }
                ]
            }
        }
    },
