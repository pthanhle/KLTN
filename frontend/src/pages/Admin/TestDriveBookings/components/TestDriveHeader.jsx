...
export const TestDriveHeader = ({ t, breadcrumbItems, onAddBooking, onOpenDispatch, pendingCount = 0 }) => {
    return (
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-8 w-full">
            ...
            <div className="flex flex-col sm:flex-row gap-3 mt-4 md:mt-0 w-full md:w-auto shrink-0">
                <button
                    ...
                    className="group relative flex items-center justify-center gap-2 px-6 py-3.5 bg-indigo-600 hover:bg-indigo-700 dark:bg-indigo-500/20 dark:hover:bg-indigo-500/30 text-white dark:text-indigo-400 border border-transparent dark:border-indigo-500/50 rounded-full font-black text-[11px] tracking-widest uppercase shadow-xl shadow-indigo-600/20 dark:shadow-indigo-500/10 active:scale-95 transition-all outline-none w-full sm:w-auto shrink-0"
                >
