...
const LoginForm = () => {
    ...
    return (
        <form onSubmit={onSubmit} className="space-y-4">
            ...
            <div className="space-y-1">
                <label className="text-sm font-medium text-gray-300">{t('login.passwordLabel')}</label>
                ...
                <div className="flex justify-end pt-2">
                    <a href="/forgot-password" className="text-sm !text-yellow-500 hover:!text-yellow-400 font-semibold transition">
