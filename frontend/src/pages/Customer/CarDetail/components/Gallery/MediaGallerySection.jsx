...
const MediaGallerySection = ({ gallery, t }) => {
    ...
    const galleryItems = activeTab === 'photos' ? (gallery?.photos || []) : (gallery?.videos || []);
            ...
            <div className="container mx-auto px-4 md:px-6 lg:px-10 max-w-[1440px]">
                ...
                <div className="mt-4 flex justify-start md:justify-center gap-3 lg:gap-4 px-4 overflow-x-auto custom-scrollbar pb-2 max-w-[1000px] mx-auto w-full">
                    {galleryItems.map((img, idx) => (
                        ...
                        >
                            <Image src={img} rootClassName="w-full h-full" className="!w-full !h-full object-cover" alt={`Thumbnail ${idx}`} preview={false} />
                            {activeTab === 'videos' && (
