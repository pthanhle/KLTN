...
const CarCard = ({ car }) => {
    return (
        <div className="group cursor-pointer flex flex-col w-full bg-slate-50 dark:bg-white/5 rounded-2xl overflow-hidden hover:shadow-xl dark:hover:shadow-2xl dark:hover:shadow-black/50 transition-all duration-500 hover:-translate-y-2 border border-slate-100 dark:border-white/5">
