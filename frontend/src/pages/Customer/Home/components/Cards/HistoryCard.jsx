...
const HistoryCard = ({ history, onClick }) => {
    return (
        <div
            onClick={onClick}
            className="flex flex-col min-w-[240px] w-[240px] sm:w-[280px] shrink-0 group cursor-pointer bg-slate-50 dark:bg-white/5 rounded-xl border border-slate-100 dark:border-white/5 overflow-hidden transition-all hover:border-yellow-200 dark:hover:border-yellow-500/30"
        >
