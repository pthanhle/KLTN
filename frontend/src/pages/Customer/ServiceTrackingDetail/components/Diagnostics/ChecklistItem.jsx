...
const ChecklistItem = ({ item }) => {
    ...
    if (isCritical) {
        return (
            <div className="flex relative py-3 bg-red-50 dark:bg-[#93000a]/10 px-4 -mx-4 rounded-lg overflow-hidden">
    ...
    if (isWarning) {
        return (
            <div className="flex relative py-3 bg-yellow-50 dark:bg-yellow-600/10 px-4 -mx-4 rounded-lg overflow-hidden">
                <div className="flex flex-col flex-1 pr-10">
