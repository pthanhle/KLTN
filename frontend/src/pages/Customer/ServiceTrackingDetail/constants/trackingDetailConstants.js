...
export const REPAIR_STATUS_ORDER = [
    'RECEIVED', 'DIAGNOSING', 'QUOTING', 'WAITING_PARTS', 'IN_PROGRESS', 'QC_TESTING', 'COMPLETED', 'CANCELLED'
];
...
export const TRACKING_MENU_ITEMS = [
    ...
    { id: 'progress',     labelKey: 'menu_progress',     defaultLabel: 'Tiến độ',         icon: Wrench,          minStatus: 'WAITING_PARTS' },
...
export const MOBILE_MENU_ITEMS = [
    { id: 'progress',    labelKey: 'nav_status',       defaultLabel: 'Status',      icon: Wrench,         minStatus: 'WAITING_PARTS' },
