...
export const getProgressData = (trackingId) => {
    ...
    return {
        ...
        parts_inventory: [
            { id: 'p1', part_number: 'PT-BUSH-A', name: 'Bộ bọc cao su càng A', status_code: 'DONE', fulfillment_percentage: 100 },
            { id: 'p2', part_number: 'PT-BRK-01', name: 'Bộ má phanh gốm', status_code: 'INSTALLING', fulfillment_percentage: 60 },
            { id: 'p3', part_number: 'PT-BRK-DSC', name: 'Cặp đĩa phanh tản nhiệt', status_code: 'PENDING', fulfillment_percentage: 10, estimated_arrival_at: '2026-03-25T16:00:00Z' }
        ],
        system_activity: [
