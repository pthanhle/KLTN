...
const LocationSelector = ({ branches, t }) => {
    ...
    if (bookingType === 'showroom') {
        return (
            <div key="showroom-selector" className="space-y-2.5 animate-in fade-in zoom-in-95 duration-200">
    ...
    return (
        <div key="home-selector" className="space-y-2.5 animate-in fade-in zoom-in-95 duration-200">
            <label className="text-[13px] font-bold text-slate-700 dark:text-slate-300 flex items-center gap-2">
