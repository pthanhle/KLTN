import { Camera, Shield, User, Bell, ShoppingBag, Wrench, Car, Gift } from 'lucide-react';
        ...
        <div className="flex flex-col items-center">
            ...
            <div className="w-full flex flex-col gap-2">
                ...
                <button
                    ...
                    className={`w-full flex items-center justify-between px-5 py-4 rounded-2xl group transition-all ${currentPath === '/profile/notifications'
                        ? 'bg-white dark:bg-[#141416] border border-yellow-500 shadow-[0_4px_12px_rgba(234,179,8,0.15)]'
                        : 'bg-transparent border border-transparent hover:border-slate-200 dark:hover:border-white/10'
                        }`}
                >
                    <div className="flex items-center gap-3">
                        <Bell size={18} className={currentPath === '/profile/notifications' ? 'text-yellow-500' : 'text-slate-400 group-hover:text-slate-700 dark:group-hover:text-white transition-colors'} strokeWidth={2.5} />
                        <span className={`text-[14px] font-bold transition-colors ${currentPath === '/profile/notifications' ? 'text-slate-900 dark:text-white' : 'text-slate-600 dark:text-slate-400 group-hover:text-slate-900 dark:group-hover:text-white'}`}>
                            Thông báo
                        </span>
                    </div>
                </button>
