...
import 'part_picker_catalog_item.dart';

class PartPickerSheet extends ConsumerWidget {
  ...
  static Future<void> show(BuildContext context) {
    return showModalBottomSheet(
      ...
      builder: (context) => const PartPickerSheet(),
    );
  }
              ...
              children: [
                ...
                Padding(
                  ...
                  child: CupertinoSearchTextField(
                    placeholder: 'Tìm kiếm theo tên, mã SKU...'.tr(),
                ...
                Expanded(
                  child: ListView.builder(
                    padding: const EdgeInsets.symmetric(horizontal: 24, vertical: 8),
                    itemCount: mockMasterPartsCatalog.length,
                    itemBuilder: (context, index) {
                      final part = mockMasterPartsCatalog[index];
                      return PartPickerCatalogItem(
                        part: part,
                        onAdd: () {
