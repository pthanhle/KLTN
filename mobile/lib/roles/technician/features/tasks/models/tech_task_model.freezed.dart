...
mixin _$TechTaskModel {
 ...
 String get id; String get plate; String get model; String get bay; String get startTime; String get endTime; String get role; TechTaskUrgency get urgency; TechTaskStatus get status;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,plate,model,bay,startTime,endTime,role,urgency,status);

@override
String toString() {
  return 'TechTaskModel(id: $id, plate: $plate, model: $model, bay: $bay, startTime: $startTime, endTime: $endTime, role: $role, urgency: $urgency, status: $status)';
}
...
@useResult
$Res call({
 String id, String plate, String model, String bay, String startTime, String endTime, String role, TechTaskUrgency urgency, TechTaskStatus status
});
...
/// Create a copy of TechTaskModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? plate = null,Object? model = null,Object? bay = null,Object? startTime = null,Object? endTime = null,Object? role = null,Object? urgency = null,Object? status = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String plate,  String model,  String bay,  String startTime,  String endTime,  String role,  TechTaskUrgency urgency,  TechTaskStatus status)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TechTaskModel() when $default != null:
return $default(_that.id,_that.plate,_that.model,_that.bay,_that.startTime,_that.endTime,_that.role,_that.urgency,_that.status);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String plate,  String model,  String bay,  String startTime,  String endTime,  String role,  TechTaskUrgency urgency,  TechTaskStatus status)  $default,) {final _that = this;
switch (_that) {
case _TechTaskModel():
return $default(_that.id,_that.plate,_that.model,_that.bay,_that.startTime,_that.endTime,_that.role,_that.urgency,_that.status);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String plate,  String model,  String bay,  String startTime,  String endTime,  String role,  TechTaskUrgency urgency,  TechTaskStatus status)?  $default,) {final _that = this;
switch (_that) {
case _TechTaskModel() when $default != null:
return $default(_that.id,_that.plate,_that.model,_that.bay,_that.startTime,_that.endTime,_that.role,_that.urgency,_that.status);case _:
  return null;
...
class _TechTaskModel extends TechTaskModel {
  const _TechTaskModel({required this.id, required this.plate, required this.model, required this.bay, required this.startTime, required this.endTime, required this.role, required this.urgency, required this.status}): super._();
...
/// Create a copy of TechTaskModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? plate = null,Object? model = null,Object? bay = null,Object? startTime = null,Object? endTime = null,Object? role = null,Object? urgency = null,Object? status = null,}) {
